...
const Unidades = () => {
    ...
    // Arreglos de imágenes para cada unidad
    ...
    // Abre el carrusel desde la imagen específica
    const handleImageClick = (unidadImages) => {
        setSelectedImageIndex(0);  
        setShowCarrusel(true);
        setSelectedImages(unidadImages);  // Asigna el arreglo de imágenes correspondiente a la unidad
    };
    ...
    return (
        <div className='Unidades'>    
            ...
            {showCarrusel && (
            <GaleriaImagenes 
                images={selectedImages}  // Usa el estado con las imágenes seleccionadas
